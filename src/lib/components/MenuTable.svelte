...
>
  <div class="mt-10">
    <img src="/img/meja.svg" alt="desk menu" />
  </div>
  <div class="absolute grid grid-cols-5 gap-12">
    <a href="/home-screen">
      <img src="/img/stopwatch.svg" alt="stopwatch" />
    </a>
    <a href={void 0} class="cursor-not-allowed">
      <img src="/img/calendar.svg" alt="calendar" />
    </a>
    <a href="/session/incomplete">
      <img src="/img/task-list.svg" alt="task list" />
    </a>
    <a href={void 0} class="cursor-not-allowed">
      <img src="/img/settings.svg" alt="settings menu" />
    </a>
    <a href={void 0} class="cursor-not-allowed">
